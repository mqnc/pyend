...
echo python3 $PYEND $PYEND -s --out pyend.noend.py
python3 $PYEND $PYEND -s --out pyend.noend.py
echo

echo inserting end marks...
echo python3 $PYEND pyend.noend.py -e --out pyend.end.py
python3 $PYEND pyend.noend.py -e --out pyend.end.py
echo
...
echo python3 $PYEND pyend.noindent.txt -i --out pyend.reindent.py
python3 $PYEND pyend.noindent.txt -i --out pyend.reindent.py
echo
